...
function getDisplayEventDate(event) {
  ...
  var displayEventDate;
	...
	var endTimeEventInfo = moment(event.end).format('YYYY/MM/DD');
...
var calendar = $('#calendar').fullCalendar({
  ...
  eventRender: function (event, element, view) {
    ...
    element.popover({
      ...
      content: $('<div />', {
        ...
        .append('<p><strong>상태:</strong> ' + event.type + '</p>')
        .append('<p><strong>기간:</strong> ' + getDisplayEventDate(event) + '</p>')
  ...
  events: function (start, end, timezone, callback) {
    $.ajax({
      type: "get",
      url: "http://localhost:9090/tumblbugs/admin/collection/calendar_list",
      data: {
  ...
  eventDrop: function (event, delta, revertFunc, jsEvent, ui, view) {
    ...
    $.ajax({
      type: "get",
      url: "http://localhost:9090/tumblbugs/admin/collection/calendar_updateDrag?col_id="+event._id+"&col_startdate="+newDates.startDate+"&col_enddate="+newDates.endDate,
      data: {
        //...
      },
      success: function (response) {
