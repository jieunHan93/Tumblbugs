...
<body>
	<div id="admin_mainpage">
		...
		<div id="admin_mainconent">
			...
			<div id="admin_answer">
				<form action="faq_update_proc" method="post" name="faqForm" id="faqForm">
					<table id="answer">
						<tr>
							<th>유형 선택</th>
							<td>
						...
						<tr>
							<th>리스트 제목</th>
							<td><input type="text" name="faq_list_title" id="faq_list_title" style="width: 500px;" value="${vo.faq_list_title}"></td>
						</tr>
						<tr>
							<th>내용</th>
							<td><textarea name="faq_content" id="faq_content">${vo.faq_content}</textarea></td>
						</tr>
						<tr>
							<th>메인 노출 여부</th>
							<td>
						...
						<tr>
							<td colspan="5">
								...
								<a><button type="button" id="btnInsert" style="margin-right: 10px;cursor: pointer;">수정</button></a>
