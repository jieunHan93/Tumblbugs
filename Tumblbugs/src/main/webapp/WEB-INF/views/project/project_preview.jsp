...
<body>
	<div id="project_content">
		...
		<section id="overview">
			...
			<div>
				...
				<div class="preview"  id="introduction">
					...
					<div>
						<a href="http://localhost:9090/tumblbugs/funding/step1"><button type="button" id="goFunding">프로젝트 밀어주기</button></a>
		...
		<section id="menu_tab">
			<nav>
				<a class="active" id="story" href="http://localhost:9090/tumblbugs/project_preview?tab=story">스토리</a>
				<a class="active" id="community" href="http://localhost:9090/tumblbugs/project_preview?tab=community">커뮤니티
					<c:if test="${vo.community_count ne '0'}">
						<span id="community_count">${vo.community_count }</span>
					</c:if>
				</a>
				<a class="active" id="fundingInfo" href="http://localhost:9090/tumblbugs/project_preview?tab=fundingInfo">펀딩 안내</a>
			</nav>
		</section>
		<section id="menu_content">
			<div>
				...
				<div class="menu_content" id="fundingInfo">
