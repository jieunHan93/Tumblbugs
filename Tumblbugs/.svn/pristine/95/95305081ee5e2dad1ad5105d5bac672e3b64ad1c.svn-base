 ...
 <div class="content_menu_title">프로젝트 개요</div>
	<div id="pro_intro">
		<div id="content_pro_title" class="upload_detail_slide" >
			...
			<div id="title_write"><i class="far fa-edit"></i>
				<c:if test="${vo.pj_title == null}"> 입력하기</c:if>
				<c:if test="${vo.pj_title != null}"> 수정하기</c:if>
			</div>
		</div>
		...
		<div id="content_pro_category" class="upload_detail_slide" >
			...
			<div id="title_write"><i class="far fa-edit"></i>
				<c:if test="${vo.pj_category == null}"> 입력하기</c:if>
				<c:if test="${vo.pj_category != null}"> 수정하기</c:if>
			</div>	
		</div>
		...
		<div id="content_pro_tag" class="upload_detail_slide" >
			...
			<div id="title_write"><i class="far fa-edit"></i>
				<c:if test="${vo.pj_tag == null}"> 입력하기</c:if>
				<c:if test="${vo.pj_tag != null}"> 수정하기</c:if>
			</div>
		</div>
	...
	<div id="pro_my_info">
		...
		<div id="content_my_name_d" class="upload_detail">
			...
			<div>
				<input type="text" placeholder=" 이름을 입력해주세요." style="resize:none" class="m1_check" id="m1_c6_i1" value="${mvo.name}"/>
		...
		<div id="content_my_intro_d" class="upload_detail">
			...
			<div><textarea placeholder="창작자 소개를 입력해주세요." style="resize:none" class="m1_check" id="m1_c7_i1"><c:if test="${mvo.intro != null}">${mvo.intro}</c:if>
			</textarea></div>
